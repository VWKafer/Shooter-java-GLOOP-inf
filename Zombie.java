...
public class Zombie {
 ...
 /////////////////
    ...
    public Zombie(int nummer,Global_Variables Global2,int Feinde2,Player Player2,boolean stationaer2){
        feindnummer= nummer;
    ...
    public void Stab()
    {
        if (Math.abs(sicht.gibX()-Player.gibX())<sichtWeiteVorne && Math.abs(sicht.gibZ()-Player.gibZ())<sichtWeiteVorne) {
            ...
            int dist = (int) Math.sqrt((gibX()-Player.gibX())*(gibX()-Player.gibX())+(gibZ()-Player.gibZ())*(gibZ()-Player.gibZ()));
